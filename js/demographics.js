d3.csv("population.csv", function(err, data) {
  ...
  var config = {"color1":"#c3e2ff","color2":"#08306B","mainCategory":"Washington","averageCategory":"Nation Average","stateDataColumn":"state","valueDataColumn":"Europeans"}
